...
(function(window, document, undefined) {
    ...
    /**
     * Search element with data-yavjs-rules attribute to add automatically in
     * the field array to be validate.
     * @private
     */
    FormValidator.prototype._autoloadField = function () {
        var elements = document.querySelectorAll('[data-yavjs-rules]');
        var fields = [];
        ...
        for (i = 0, ruleLength = rules.length; i < ruleLength; i++) {
             ...
             */
                ...
                if (failed) {
                    ...
                    return errorObject; // for manual validation
                }
            }
